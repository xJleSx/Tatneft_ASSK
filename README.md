...
| **Рязанцев А.А.** | Fullstack | Склейка фронт ↔ бэк, REST-контракты, выкатка, девопс |
| **Соловьёв М.В.** | Аналитика | Бизнес-требования, формализация правил авто-проверки, сценарии E2E |
| **Швецова В.Д.** | UX/UI дизайн | Дизайн-система «АСКК», фирменный стиль и состояния интерфейса |
